...
export function CreateAdModal() {
  ...
  async function handleCreateAd(event: React.FormEvent) {
    ...
    //TODO: Validar os dados com o React Hook Form no Schema Validation e Zod
    if (!data.game) {
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed bg-[#2a2643] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg mw-[620px] shadow-black">
        ...
        <form onSubmit={handleCreateAd} className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input name="discord" id="discord" placeholder="Fulano#1234" />
            </div>
          </div>
